  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data) {
        ...
        // User details local storage mein save kar sakte hain
        localStorage.setItem("user", JSON.stringify(response.data.hirer));
        window.location.href = "/admin"; // Page refresh taaki navbar update ho
      }
    } catch (error) {
